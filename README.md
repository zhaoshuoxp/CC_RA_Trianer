...
功能包括设置或保持最低资金、无限电力、我方单位与建筑无敌、剧情增援单位保护、护盾不减、快速生产，以及《凯恩之怒》全球征服资金。超级武器／支援能力无冷却功能尚未实现。热键只在游戏窗口位于前台时响应，读档或进入新地图会自动关闭功能。

原版 1.10 已在 GDI 战役中完成暂停状态连接、资金读取、建筑与单位直接完成的实机验证；其余版本尚待实机验证。当前 C&C3 EXE SHA-256：`2517DE04ADBECF29C9C6216FA6425B39569ED72FE8F187ED5CBCE87CA4135D54`。
